...
namespace ProjectSetup.Controllers.V1
{
    ...
    public class CategoryController : ControllerBase
    {
		...
		[CustomExceptionFilter(typeof(CategoryNotFoundException), HttpStatusCode.NotFound)]
		...
		public async Task<IActionResult> Create([FromBody] CreateCategoryRequest postRequest)
        {
            ...
            {
                throw new CategoryBadRequestException("Category with Name: '" + category.Name + "' already exists");
            }
